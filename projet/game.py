...
class Game:
    ...
    def setup(self):  # pylint: disable=too-many-locals,too-many-statements
        ...
        open_cmd = Command(
            "open",
            ": ouvrir le coffre fort de la salle des profs",
            Actions.open_safe,
            0,
            "Interaction",
        )
